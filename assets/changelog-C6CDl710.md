...
- chore: update lsp-server build configuration ([cc0f9d2](https://github.com/fengkx/beancount-lsp/commit/cc0f9d2))
...
- fix: token color customizations for Beancount in lsp-client package.json [#89](https://github.com/fengkx/beancount-lsp/issues/89) ([2f7899a](https://github.com/fengkx/beancount-lsp/commit/2f7899a))
