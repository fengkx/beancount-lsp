...
using the context menu within the extension, or included in the extension github repository [Solidity versions](https://github.com/juanfranblanco/vscode-solidity/blob/HEAD/solidity-versions.txt).
...
![Screenshot](https://github.com/juanfranblanco/vscode-solidity/raw/HEAD/screenshots/codeGenerateNethereumMultiSettings.png)
