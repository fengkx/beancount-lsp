...
* Implement c_cpp_properties.json file generator fixes [#1201](https://github.com/REditorSupport/vscode-R/issues/1201) ([#1205](https://github.com/REditorSupport/vscode-R/issues/1205), [#1201](https://github.com/REditorSupport/vscode-R/issues/1201))
* Refactoring: Strict TypeScript Fix [#1208](https://github.com/REditorSupport/vscode-R/issues/1208) ([#1209](https://github.com/REditorSupport/vscode-R/issues/1209), [#1208](https://github.com/REditorSupport/vscode-R/issues/1208))
* [Chore] Remove unused NPM dependencies fix [#232](https://github.com/REditorSupport/vscode-R/issues/232) ([#1216](https://github.com/REditorSupport/vscode-R/issues/1216))
...
* Don't run chunks with eval = FALSE. Fixes [#651](https://github.com/REditorSupport/vscode-R/issues/651) ([#651](https://github.com/REditorSupport/vscode-R/issues/651))
* Don't run chunks with eval = FALSE. Fixes [#651](https://github.com/REditorSupport/vscode-R/issues/651) ([#653](https://github.com/REditorSupport/vscode-R/issues/653), [#651](https://github.com/REditorSupport/vscode-R/issues/651))
...
* Fix [#572](https://github.com/REditorSupport/vscode-R/issues/572) ([#572](https://github.com/REditorSupport/vscode-R/issues/572))
...
* Move `r.runSource` and `r.knitRmd` to `editor/title/run` (Fix [#572](https://github.com/REditorSupport/vscode-R/issues/572)) ([#573](https://github.com/REditorSupport/vscode-R/issues/573), [#572](https://github.com/REditorSupport/vscode-R/issues/572))
...
* Find in topic (help panel) [#463](https://github.com/REditorSupport/vscode-R/issues/463) ([#488](https://github.com/REditorSupport/vscode-R/issues/488))
...
* Fix whole of style (Extends [#361](https://github.com/REditorSupport/vscode-R/issues/361)) ([#474](https://github.com/REditorSupport/vscode-R/issues/474))
...
* Fixes [#443](https://github.com/REditorSupport/vscode-R/issues/443) ([#462](https://github.com/REditorSupport/vscode-R/issues/462))
* Reorganize helppanel, add `?` function ([#477](https://github.com/REditorSupport/vscode-R/issues/477))
* Update README for [#465](https://github.com/REditorSupport/vscode-R/issues/465)
* Update README for [#465](https://github.com/REditorSupport/vscode-R/issues/465) ([#480](https://github.com/REditorSupport/vscode-R/issues/480))
...
* fix [#265](https://github.com/REditorSupport/vscode-R/issues/265) ([#265](https://github.com/REditorSupport/vscode-R/issues/265))
* Fix main.yml
* Fix eslint
* fix vlunerability
* fix vscode version
...
* Fixed the function snippet (Issue [#230](https://github.com/REditorSupport/vscode-R/issues/230))
* Fixed the function snippet (Issue [#230](https://github.com/REditorSupport/vscode-R/issues/230)) ([#231](https://github.com/REditorSupport/vscode-R/issues/231))
* add collaborator
* version 1.2.3
* update vscode
...
* Support single quote (Fix [#260](https://github.com/REditorSupport/vscode-R/issues/260)) ([#264](https://github.com/REditorSupport/vscode-R/issues/264), [#260](https://github.com/REditorSupport/vscode-R/issues/260))
...
* Use bracketed paste for more commands [#294](https://github.com/REditorSupport/vscode-R/issues/294) ([#305](https://github.com/REditorSupport/vscode-R/issues/305))
...
* Migrate to vscode-test [#315](https://github.com/REditorSupport/vscode-R/issues/315) ([#317](https://github.com/REditorSupport/vscode-R/issues/317))
...
* update CHANGELOG for following [#359](https://github.com/REditorSupport/vscode-R/issues/359)
* Update changelog
...
* Fix [#168](https://github.com/REditorSupport/vscode-R/issues/168) ([#168](https://github.com/REditorSupport/vscode-R/issues/168))
...
* add wordPattern (fixed [#75](https://github.com/REditorSupport/vscode-R/issues/75)) ([#75](https://github.com/REditorSupport/vscode-R/issues/75))
* version 0.6.2
...
* Fix Preview Dataframe command [#67](https://github.com/REditorSupport/vscode-R/issues/67) ([#97](https://github.com/REditorSupport/vscode-R/issues/97))
* version 1.0.3
...
* Add runSelectionInActiveTerm command [#80](https://github.com/REditorSupport/vscode-R/issues/80) [#102](https://github.com/REditorSupport/vscode-R/issues/102) ([#104](https://github.com/REditorSupport/vscode-R/issues/104))
* miss to merge
* version 1.0.7
* .gitignore is now working
* version 1.0.8
* Fix check for Excel Viewer extension [#96](https://github.com/REditorSupport/vscode-R/issues/96) ([#108](https://github.com/REditorSupport/vscode-R/issues/108))
* add gc-excel installer
* version 1.0.9
* version 1.1.0
* Fix Preview Environment for multi-class objects [#111](https://github.com/REditorSupport/vscode-R/issues/111) ([#113](https://github.com/REditorSupport/vscode-R/issues/113))
* Fix Preview Environment for variable x [#111](https://github.com/REditorSupport/vscode-R/issues/111) ([#115](https://github.com/REditorSupport/vscode-R/issues/115))
* version 1.1.1
* version 1.1.2
* Add bracketed paste mode option
* Do not send blank lines to console
* Fix send code for newlines and Radian [#114](https://github.com/REditorSupport/vscode-R/issues/114) [#117](https://github.com/REditorSupport/vscode-R/issues/117) ([#119](https://github.com/REditorSupport/vscode-R/issues/119))
...
* Automatically comment new lines in roxygen sections [#124](https://github.com/REditorSupport/vscode-R/issues/124) ([#130](https://github.com/REditorSupport/vscode-R/issues/130))
* Do not send blank lines ending in CRLF to console
* Fix send code for newlines on Windows [#114](https://github.com/REditorSupport/vscode-R/issues/114) ([#125](https://github.com/REditorSupport/vscode-R/issues/125))
* add roxygen comments
* Add auto-completion of roxygen tags
* Add auto-completion of roxygen tags [#128](https://github.com/REditorSupport/vscode-R/issues/128) ([#131](https://github.com/REditorSupport/vscode-R/issues/131))
* Change cursorMove
...
* Add alwaysUseActiveTerminal setting [#123](https://github.com/REditorSupport/vscode-R/issues/123) ([#133](https://github.com/REditorSupport/vscode-R/issues/133))
* version 1.1.5
...
* refactoring
* version 1.1.6
* remove duplicated quote [#139](https://github.com/REditorSupport/vscode-R/issues/139)
* version 1.1.7
* Use word under cursor for previewDataframe, nrow
* Apply functions once instead of to each line
* remove extra calling
* Use word under cursor for previewDataframe, nrow [#137](https://github.com/REditorSupport/vscode-R/issues/137) ([#141](https://github.com/REditorSupport/vscode-R/issues/141))
* Delete LICENSE
* Create LICENSE
* version 1.1.8
* version 1.1.8
...
* Fix for [#42](https://github.com/REditorSupport/vscode-R/issues/42)
* fix CO
* fix [#65](https://github.com/REditorSupport/vscode-R/issues/65) ([#65](https://github.com/REditorSupport/vscode-R/issues/65))
...
* update dependency
* Fix for [#42](https://github.com/REditorSupport/vscode-R/issues/42) ([#63](https://github.com/REditorSupport/vscode-R/issues/63))
* revert fix
* version 0.5.8
* version 0.5.9
...
* Fix for [#61](https://github.com/REditorSupport/vscode-R/issues/61)
...
* Additional Fix [#61](https://github.com/REditorSupport/vscode-R/issues/61) ([#61](https://github.com/REditorSupport/vscode-R/issues/61))
* version 0.5.7
...
* little fix
* update run icon(fix [#21](https://github.com/REditorSupport/vscode-R/issues/21)) ([#21](https://github.com/REditorSupport/vscode-R/issues/21))
* remove extra test
...
* Update TODO
* version 0.4.5
* Environment preview [#23](https://github.com/REditorSupport/vscode-R/issues/23)
* version 0.4.5
* remove extra files
...
* Removed new line
* Proposed fix for Load Chunk problems [#27](https://github.com/REditorSupport/vscode-R/issues/27) ([#31](https://github.com/REditorSupport/vscode-R/issues/31))
...
* version 0.5.2
* version 0.5.3
* R term name to R interactive (fix [#46](https://github.com/REditorSupport/vscode-R/issues/46)) ([#46](https://github.com/REditorSupport/vscode-R/issues/46))
* Send code from Rmd chunk to terminal [#49](https://github.com/REditorSupport/vscode-R/issues/49)
* version 0.5.4
...
* fix
* fix syntax
* fix [#7](https://github.com/REditorSupport/vscode-R/issues/7) ([#7](https://github.com/REditorSupport/vscode-R/issues/7))
...
* clean
* Merge pull request [#1](https://github.com/REditorSupport/vscode-R/issues/1) from Ikuyadeu/master
* Fixed typos
* Fixed typos
* Fixed typos
...
* fix [#9](https://github.com/REditorSupport/vscode-R/issues/9) ([#9](https://github.com/REditorSupport/vscode-R/issues/9))
...
* tslint
* set focus [#5](https://github.com/REditorSupport/vscode-R/issues/5)
* version 0.2.7
...
* fix Terminal type
* fix [#1](https://github.com/REditorSupport/vscode-R/issues/1) ([#1](https://github.com/REditorSupport/vscode-R/issues/1))
* fix keywords
* fix for windows
* fix
* fix [#2](https://github.com/REditorSupport/vscode-R/issues/2) ([#2](https://github.com/REditorSupport/vscode-R/issues/2))
