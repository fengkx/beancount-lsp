...
enum {
  ...
  sym_note_directive = 46,
  sym_document_directive = 47,
  sym_event_directive = 48,
  sym_option_directive = 49,
  sym_plugin_directive = 50,
  sym_include_directive = 51,
  sym_account_name = 52,
  sym_account_type = 53,
  sym_metadata = 54,
  sym__num_expr = 55,
  sym_paren_num_expr = 56,
  sym_unary_num_expr = 57,
  sym_binary_num_expr = 58,
  sym_metadata_key = 59,
  sym__new_line = 60,
  sym_colon = 61,
  aux_sym_file_repeat1 = 62,
  aux_sym_directive_repeat1 = 63,
  aux_sym_open_directive_repeat1 = 64,
  aux_sym_account_name_repeat1 = 65,
};
...
enum {
  ...
  field_note = 17,
  field_option_name = 18,
  field_option_value = 19,
  field_plugin_config = 20,
  field_price = 21,
};
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_pad_directive] = STATE(10),
    [sym_balance_directive] = STATE(10),
    [sym_open_directive] = STATE(10),
    [sym_close_directive] = STATE(10),
    [sym_price_directive] = STATE(10),
    [sym_note_directive] = STATE(10),
    [sym_document_directive] = STATE(10),
    [sym_event_directive] = STATE(10),
    [sym_option_directive] = STATE(10),
    [sym_plugin_directive] = STATE(10),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [28] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2), SHIFT_REPEAT(75),
  [31] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2), SHIFT_REPEAT(74),
  [34] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2), SHIFT_REPEAT(45),
  ...
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_colon, 1),
  [71] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_colon, 1),
  [73] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_directive, 1),
  [75] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_directive, 1),
  ...
  [85] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_directive_repeat1, 2),
  [87] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_directive_repeat1, 2), SHIFT_REPEAT(68),
  [90] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_directive_repeat1, 2), SHIFT_REPEAT(11),
  [93] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_directive_repeat1, 2), SHIFT_REPEAT(11),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_directive, 2),
  [98] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_directive, 2),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_metadata, 3, .production_id = 12),
  [102] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_metadata, 3, .production_id = 12),
  [104] = {.entry = {.count = 1, .reusable = false}}, SHIFT(43),
  [106] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_account_name_repeat1, 2), SHIFT_REPEAT(77),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_account_name_repeat1, 2),
  [111] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_account_name_repeat1, 2),
  [113] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_account_name_repeat1, 2), SHIFT_REPEAT(66),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_account_name, 2),
  [118] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_account_name, 2),
  [120] = {.entry = {.count = 1, .reusable = false}}, SHIFT(66),
  [122] = {.entry = {.count = 1, .reusable = true}}, SHIFT(77),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_open_directive, 5, .production_id = 13),
  [126] = {.entry = {.count = 1, .reusable = false}}, SHIFT(80),
  [128] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_open_directive, 5, .production_id = 13),
  ...
  [136] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_open_directive_repeat1, 2), SHIFT_REPEAT(80),
  ...
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_balance_directive, 5, .production_id = 15),
  [155] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_balance_directive, 5, .production_id = 15),
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_include_directive, 2, .production_id = 2),
  [159] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_include_directive, 2, .production_id = 2),
  ...
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pad_directive, 4, .production_id = 11),
  [171] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pad_directive, 4, .production_id = 11),
  [173] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_document_directive, 4, .production_id = 10),
  [175] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_document_directive, 4, .production_id = 10),
  ...
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_note_directive, 4, .production_id = 9),
  [183] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_note_directive, 4, .production_id = 9),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_price_directive, 5, .production_id = 14),
  [187] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_price_directive, 5, .production_id = 14),
  ...
  [255] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_metadata_key, 1, .production_id = 3),
  ...
  [271] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_account_type, 1),
